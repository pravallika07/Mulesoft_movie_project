  ...
  public static void main(String[] args) {
    try {
      ...
      if(con != null) {
    	...
    	//int n=st.executeUpdate("create table movie_data(name text,actor_name text,actress_name text,director_name text,release_year int)");
    	...
    	PreparedStatement pstmt = con.prepareStatement("select * from movie_data");
